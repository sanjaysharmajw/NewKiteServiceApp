class AddServiceRequestBody {
  ...
  AddServiceRequestBody.fromJson(dynamic json) {
...
AddServiceRequestBody copyWith({  String? userId,
  String? serviceId,
  String? serviceName,
  String? title,
  String? address,
  ...
  AddressDetails? addressDetails,
  String? registrationNumber,
}) => AddServiceRequestBody(  userId: userId ?? _userId,
