...
import 'package:nirbhaya_service/BodyRequest/update_service_list_request_body.dart';
...
class UpdateAddServiceController extends GetxController{
  ...
  Future<AddServiceModel?> addUpdateServiceListApi(UpdateServiceListRequestBody addServiceRequestBody ) async {

    try {
      CustomLoader.showLoader("Please wait");
      final response = await http.post(Uri.parse(APIConstant.updateAddServiceRequest),
        headers: headerController.headerToken, body: jsonEncode(addServiceRequestBody),);
      Map<String, dynamic> responseBody = json.decode(response.body);
      debugPrint('UpdayteServiceRequest');
