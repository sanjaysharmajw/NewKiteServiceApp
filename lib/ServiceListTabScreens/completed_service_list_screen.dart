...
class CompletedServiceListScreen extends StatefulWidget {
  String? status;
  CompletedServiceListScreen({Key? key, this.status}) : super(key: key);

  @override
  State<CompletedServiceListScreen> createState() =>
      CompletedServiceListScreenState();
}

class CompletedServiceListScreenState
    extends State<CompletedServiceListScreen> {
