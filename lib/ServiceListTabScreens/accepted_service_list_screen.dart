...
class AcceptedServiceListScreen extends StatefulWidget {
  String? status;
  AcceptedServiceListScreen({Key? key, this.status}) : super(key: key);

  @override
  State<AcceptedServiceListScreen> createState() =>
      AcceptedServiceListScreenState();
}
