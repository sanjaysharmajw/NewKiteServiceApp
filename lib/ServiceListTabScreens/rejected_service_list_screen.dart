...
class RejectedServiceListScreen extends StatefulWidget {
  String? status;
  RejectedServiceListScreen({Key? key, this.status}) : super(key: key);

  @override
  State<RejectedServiceListScreen> createState() =>
      RejectedServiceListScreenState();
}

class RejectedServiceListScreenState extends State<RejectedServiceListScreen> {
