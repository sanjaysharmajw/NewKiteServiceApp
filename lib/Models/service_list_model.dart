class ServiceListModel {
  ...
  ServiceListModel.fromJson(dynamic json) {
    ...
    if (json['data'] != null) {
      _data = [];
      json['data'].forEach((v) {
        _data?.add(UserServiceListData.fromJson(v));
      });
    }
  }
  bool? _status;
  List<UserServiceListData>? _data;
ServiceListModel copyWith({  bool? status,
  List<UserServiceListData>? data,
}) => ServiceListModel(  status: status ?? _status,
  data: data ?? _data,
);
  bool? get status => _status;
  List<UserServiceListData>? get data => _data;
...
class UserServiceListData {
  ...
  UserServiceListData.fromJson(dynamic json) {
    _id = json['_id'];
  ...
  num? _dist;
  UserServiceListData copyWith({  String? id,
  String? userId,
  String? serviceId,
  String? serviceName,
  String? title,
